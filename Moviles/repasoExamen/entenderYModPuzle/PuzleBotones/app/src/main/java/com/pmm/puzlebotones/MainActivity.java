...
public class MainActivity extends AppCompatActivity {
    ...
    private void comprobarVictoria() {
        ...
        //forma de la ia=   int red = ContextCompat.getColor(this, R.color.victory_red);
        for (int fila = 0; fila < 3; fila++) {
            for (int col = 0; col < 3; col++) {
                botones[fila][col].setBackgroundColor(redV);
            }
        }
        Toast.makeText(this, "¡lo logreeee! 🎉", Toast.LENGTH_LONG).show();
    }
